ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Jen&Earl's General Store"
  ...
  #
  config.site_title_image = "https://cdn.iconscout.com/icon/free/png-256/free-shopping-logo-icon-svg-download-png-450618.png"
